 ...
 * @author    Arkanite
 * @license   GPL-3.0
 * @link      https://arkanite.com
 * @copyright 2021 Arkanite
 */
...
class Admin
{
    ...
    public function add_plugin_admin_menu()
    {
        ...
        $this->plugin_screen_hook_suffix = add_options_page(
            __('CSV Import', $this->plugin_slug),
            __('CSV Import', $this->plugin_slug),
            'manage_options',
            $this->plugin_slug,
    ...
    {
        ?>
        <div id="csv-import-admin"></div>
        <!--		<div id="csv-import-ajax-nonce" data-nonce="--><?php //echo wp_create_nonce('post_ekomi'); ?><!--"></div>-->
        <div id="csv-import-ajax-nonce" data-nonce="<?php echo wp_create_nonce('post_formation'); ?>"></div>
        <?php
    }
